...
const Footer = () => {
  ...
  return (
    <footer className=" w-full ">
      <div className="flex flex-col items-center justify-around gap-5 bg-primary-700 mt-24 py-16 px-24 lg:flex-row">
        <div className="flex flex-col items-center justify-center lg:items-start">
          <img src="./assets/Behja.svg" alt="Behja" />
          <p
            className="heading-04-bold text-center text-shades-white mt-8 lg:text-start"
