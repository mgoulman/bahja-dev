  ...
  return (
    <div className="flex flex-col w-[90%] lg:w-[75%] gap-5 p-8 bg-shades-white">
      ...
      <div className="flex flex-col gap-5 lg:flex-row items-center justify-between">
        <Dropdown
          width={"280px"}
          placeholder={"Duration of the rental"}
        ...
        <Dropdown
          width={"280px"}
          placeholder={"Future property value"}
          src={"./assets/House.svg"}
          setData={(selectedValue) => setFilterData.setFutureValue(selectedValue)}
          options={futureValueOptions}
        />
      </div>
      <button className="paragraph-01-regular bg-primary-500 text-shades-white px-8 py-3 w-full lg:w-[25%]" onClick={() => onSearch()}>
