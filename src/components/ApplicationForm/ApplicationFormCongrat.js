        ...
        <div className="flex flex-col items-center w-full mt-5">
          <div className="flex flex-col  gap-4  w-full">
            <div className="flex flex-row items-center justify-around">
              <div className="flex items-center justify-around px-4 py-3 bg-neutral-50 gap-2 w-[45%] hover:cursor-pointer" onClick={() => navigate('/applicationformdocsupload')}>
          ...
          <button className="w-[90%] bg-neutral-50 flex items-center justify-center  gap-2 px-4 py-3" onClick={() => navigate('/applicationformdocsupload')}>
            <AiOutlineMail />
