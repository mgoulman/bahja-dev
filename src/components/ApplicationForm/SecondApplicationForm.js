          ...
          <div className="flex flex-col mb-5 gap-2">
            ...
            <div className="flex items-start justify-between">
              <div className="flex flex-col gap-1 w-[45%]">
                ...
                >
                  <CheckBox setChecked={setIsSaudi} value={"saudi"} cheCkedValue={isSaudi}/>
                  <p
              ...
              <div className="flex flex-col gap-1 w-[45%]">
                ...
                >
                  <CheckBox setChecked={setIsSaudi} value={"nonSaudi"} cheCkedValue={isSaudi}/>
                  <p
                    className={`paragraph-02-regular  ${
                      errors.saudi
                        ? "text-red-500"
          ...
          <div className="flex flex-col mb-5 gap-2">
            ...
            <div className="flex items-start justify-between">
              <div className="flex flex-col gap-1 w-[45%]">
                ...
                >
                  <CheckBox setChecked={setIsQualify} value={"yes"} cheCkedValue={isQualify} />
                  <p
                    className={`paragraph-02-regular  ${
                      errors.qualify
                        ? "text-red-500"
              ...
              <div className="flex flex-col gap-1 w-[45%]">
                ...
                >
                  <CheckBox setChecked={setIsQualify} value={"no"} cheCkedValue={isQualify} />
                  <p
                    className={`paragraph-02-regular  ${
                      errors.qualify
                        ? "text-red-500"
