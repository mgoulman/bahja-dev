        ...
        <div className="flex flex-row justify-between pt-4">
          <div className="flex-col">
            <img
              ...
              onClick={() => navigate('/')}
            />
            <button onClick={() => navigate(-1)} className={`${isFinish ? 'hidden' : 'block'}`}>
        ...
        {isFinish ? (
          <div className="flex flex-col items-start self-center justify-center mt-28 gap-5">
             <div className="flex flex-col gap-2 mt-5">
              <h1 className="heading-03-semibold text-primary-900" style={{ whiteSpace: "pre-line" }}>
                {t("We have received\nyour documents!")}
              </h1>
              <p
            ...
            <button className="text-shades-white px-8 py-3 bg-primary-500" onClick={() => navigate('/')}>Back Home</button>
          </div>
        ) : (
          <>
            {" "}
