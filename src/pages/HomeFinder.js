    ...
    <div className="flex flex-col items-center justify-center bg-primary-50">
      ...
      <div className="relative w-full">
        <div className=" flex flex-col lg:flex-row justify-between w-full">
          <div className="flex flex-col items-start pl-4 lg:pl-[12.5%]">
            <button className="mb-10" onClick={() => navigate('/')}>
              <img src="./assets/ArrowLeft.svg" alt="arrow" />
            </button>
            <p className="display-02-bold text-primary-900 whitespace-pre-line">
              {t("Search for\nyour future home")}
            </p>
          ...
          <div className="relative w-full lg:w-[50%]">
            <div className="absolute bg-gradient-to-b h-full  lg:bg-gradient-to-t from-primary-50 via-transparent to-transparent w-full lg:h-1/2 bottom-0" />
            <div className="absolute bg-gradient-to-t lg:bg-gradient-to-r from-primary-50 via-transparent to-transparent w-full h-full" />
            <img
